...
class Runner {
  ...
  @JsonKey(name: 'current_pods')
  final int currentPods;
  @JsonKey(name: 'max_concurrent_pods')
  final int maxConcurrentPods;
  ...
  Runner({
    ...
    required this.status,
    this.lastHeartbeat,
    required this.currentPods,
    required this.maxConcurrentPods,
    this.runnerVersion,
    this.hostInfo,
    required this.createdAt,
  });
  ...
  bool get hasCapacity => currentPods < maxConcurrentPods;
...
class CreatePodRequest {
  ...
  factory CreatePodRequest.fromJson(Map<String, dynamic> json) =>
      _$CreatePodRequestFromJson(json);
  Map<String, dynamic> toJson() => _$CreatePodRequestToJson(this);
}
