...
export default function DashboardLayout({
  ...
  const { token, user, currentOrg, logout, _hasHydrated } = useAuthStore();
      ...
      <aside className="w-64 border-r border-border flex flex-col">
        ...
        {currentOrg && (
          <div className="px-4 py-3 border-b border-border">
            <button className="w-full flex items-center justify-between px-3 py-2 text-sm bg-muted rounded-md hover:bg-muted/80">
