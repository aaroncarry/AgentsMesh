...
export const Terminal = forwardRef<TerminalHandle, TerminalProps>(function Terminal(
  { sessionKey, onData, onResize, className },
  ref
) {
...
export function useTerminal(sessionKey: string) {
  ...
  const connect = useCallback(() => {
    ...
    const ws = new WebSocket(`${wsUrl}/ws/terminal/${sessionKey}?token=${token}&org=${orgSlug}`);
