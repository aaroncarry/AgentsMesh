...
// createTestTables creates all required tables for runner tests
...
// createAuthTables creates auth-related tables for runner tests
func createAuthTables(t *testing.T, db *gorm.DB) {
	t.Helper()
